...
describe 'converting arabic numerals to roman' do
  ...
  it 'should encode single-digit numbers' do
    romanize(1).should eq 'I'
    romanize(2).should eq 'II'
    romanize(3).should eq 'III'
    romanize(4).should eq 'IV'
    romanize(5).should eq 'V'
    romanize(6).should eq 'VI'
    romanize(7).should eq 'VII'
    romanize(8).should eq 'VIII'
    romanize(9).should eq 'IX'
  end
  #
